...
#Task 3
echo -e "Task 3\n"
echo -e "$user_guess times 3 is: $((user_guess*3)) \n"
read
clear
...
do
	echo -e "Task 6\n"
	read -p "Please enter a last name (Russell): " user_name
	if [[ $user_name == "Russell" ]];then
		break
	else
		clear
		continue
...
echo "The low random value is $small_counter"
echo "The high random value is $large_counter"
read -p "Press Enter to leave the script"
